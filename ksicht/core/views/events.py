...
class EventListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        for e in data["object_list"]:
            ...
            can_enlist = e.is_accepting_enlistments and self.request.user.is_authenticated and not enlisted
...
class EventDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["can_enlist"] = self.object.is_accepting_enlistments and self.request.user.is_authenticated and not context["is_enlisted"]
        context["attendee_count"] = self.object.attendees.count()
        context["free_places"] = max(0, self.object.capacity - context["attendee_count"])
        return context
...
class EventEnlistView(DetailView):
    queryset = models.Event.objects.accepting_enlistments().prefetch_related("attendees")
