...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(upload_to='rocniky/reseni/', verbose_name='Soubor s řešením')),
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.GradeApplication', verbose_name='Přihláška')),
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.Task', verbose_name='Úloha')),
            ],
        ),
        migrations.CreateModel(
            name='Participant',
